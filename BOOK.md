...
這本教材以「能實際上手、能客製化、能整合到工作流」為目標，將 Pi Coding Agent 官方文件整理成實作型課程。

本書核心內容約需 60 小時完成；若包含完整作業、講師授課、團隊實驗與延伸專題，完整課程規模約 80～100 小時。
...
| 路線 | 適合對象 | 建議模組 | 時數 |
|---|---|---|---:|
| 使用者路線 | 想把 Pi 用在日常開發的人 | 01～04 | 26 |
| 客製化路線 | 想建立團隊工作流的人 | 01～06 | 46 |
| 系統整合路線 | 想用 SDK/RPC 整合系統的人 | 01～08 | 60 |
| 有經驗者快速路線 | 已用過 Claude Code、Codex、Cursor、Aider 等 agent 的人 | 遷移指南 + 02 + 05 + 06 + 07 | 30～36 |
